...
var SplashView = Backbone.View.extend({
    ...
    render: function(){
        $(this.el).load("templates/app.template");
			//	$("#gv-country").val(this.model.get("country"));
			//	$("#gv-country").val(this.mymodel.get("country"));
				// $("#gv-country").val(this.model.get("country"));
    },
    ...
    lookupCountry: function(){
        ...
        if (_.has(this.countryToPath,currentCountry) ){
					...
					// 	url: currentCountry,
					// })
					// myModel.set({country:currentCountry, url:"/country/"+currentCountry});
					//appModel.save();
					// this.model.set({count:currentCountry});
				//	 myModel.save();
